...
> An AI agent that helps founders move from idea to action to event — coaching, idea validation, and
> one-click event planning in a single app.
...
> OpenAI-compatible key. The provider-agnostic, dependency-light design keeps it fast to run, easy to
> read, and trivial to deploy.
